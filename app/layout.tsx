      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem("fap-theme");if(t!=="mono"&&t!=="default")t="default";document.documentElement.dataset.theme=t;}catch(e){document.documentElement.dataset.theme="default";}})();`,
          }}
        />
      </head>
